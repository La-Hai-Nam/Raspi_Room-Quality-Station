...
- Changes in the hardware concept after M1 presentation based on the adding and removing measruement values changes
______________
...
```
cd existing_repo
git remote add origin https://gitlab.rz.htw-berlin.de/c71_cse/2022ws_team4.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.rz.htw-berlin.de/c71_cse/2022ws_team4/-/settings/integrations)
